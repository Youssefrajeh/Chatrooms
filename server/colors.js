const colors = [
    ...
    "#512da8", "#4527a0", "#311b92", "#7c4dff",
    "#651fff", "#6200ea", "#7986cb", "#5c6bc0",
    "#3f51b5", "#3949ab", "#303f9f", "#283593",
    "#1a237e", "#536dfe", "#3d5afe", "#304ffe",
    "#42a5f5", "#2196f3", "#1e88e5", "#1976d2",
    "#1565c0", "#0d47a1", "#448aff", "#2979ff",
    "#2962ff", "#4fc3f7", "#29b6f6", "#03a9f4",
    "#039be5", "#0288d1", "#0277bd", "#01579b",
    "#00b0ff", "#0091ea", "#26c6da", "#00bcd4",
    "#00acc1", "#0097a7", "#00838f", "#006064",
    "#4db6ac", "#26a69a", "#009688", "#00897b",
    "#00796b", "#00695c", "#004d40", "#4caf50",
